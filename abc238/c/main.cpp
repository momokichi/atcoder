...
ll f(ll n) { return ((n * (n + 1)) / 2) % 998244353; }
...
int main() {
  ...
  for (ll i = 1; i < 20; ++i) {
    if (n < powl(10, i)) {
      cout << (n - ll(powl(10, i - 1))) + 1 << endl;
      cout << "f: " << f((n - ll(powl(10, i - 1))) + 1) << endl;
      ans += f((n - ll(powl(10, i - 1))) + 1);
      ans %= 998244353;
      break;
    } else {
      if (i == 1) {
        ans += f(powl(10, i) - 1);
        cout << "f1: " << f(powl(10, i) - 1) << endl;

      } else {
        ans += f(powl(10, i));
        cout << "f: " << f(powl(10, i)) << endl;
      }
      ans %= 998244353;
    }
    ans %= 998244353;
