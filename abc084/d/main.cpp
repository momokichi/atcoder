...
int main() {
  ...
  vector<bool> is_prime(101010, true);
  ...
  vector<int> sims(101010, 0);

  for (int i = 1; i < 101010; i += 2) {
    if (is_prime[i] && is_prime[(i + 1) / 2]) {
      sims[i] = 1;
    }
  }

  // rep(i, q + 2) { cout << sims[i] << " "; }
  // cout << endl;

  vector<int> s(101011, 0);

  rep(i, 101010) s[i + 1] = s[i] + sims[i];
